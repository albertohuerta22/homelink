...
public class ShelterControllerTests {
    ...
    void getAllShelters() throws Exception {
        // Arrange
        Shelter shelter1 = new Shelter("Shelter 1", "Manthattan", "Address1", 40.712776, -74.005974, "coments"); // Set properties for shelter1 as needed
        Shelter shelter2 = new Shelter("Shelter 2", "Manhattan", "Address2", 40.712776, -74.005974, "comments2"); // Set properties for shelter2 as needed
    ...
    Shelter expectedShelter = new Shelter("Shelter 1", "Manhattan", "Address1", 40.712776, -74.005974, "coments");
    ...
    Shelter originalShelter = new Shelter("Original Shelter Name", "Original Borough", "Address1", 40.712776, -74.005974, "comments2");
    ...
    Shelter updatedShelter = new Shelter("Updated Shelter Name", "Updated Borough", "Address2", 40.712776, -74.005974, "comments2");
